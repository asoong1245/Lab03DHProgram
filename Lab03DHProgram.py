...
class SecurePRNG:
    ...
    def __init__(self, seed_int):
        ...
        self.state = hashlib.sha256(seed_int.to_bytes(256, "big")).digest()
...
class Mallory:
    ...
    def intercept(self, sender, recipient, payload):
        ...
        if isinstance(payload, bytes):
            ...
            print(f"[MALLORY] Modified message: {modified.decode()}")
...
def main():
    ...
    message = b"Hello Bob, I hope you're having a wonderful day!" # Put in your test message here
